...
{
    class ReservaDAO : ICRUD<List<ReservaModel>, ReservaModel>
    {
        private static readonly string _baseUrl = $"{baseUrl}/Reservas";
        public List<ReservaModel> Get()
        {
            ...
            List<ReservaModel> reservas = JsonConvert.DeserializeObject<List<ReservaModel>>(response.Content);
            return reservas;
        }
